package com.example.view_binding_10916
...
import com.example.view_binding_10916.TaskList.taskList
import com.example.view_binding_10916.databinding.RecyclerviewItemBinding
...
class MainAdapter(val taskList: List<Task>):RecyclerView.Adapter<MainAdapter.MainViewHolder>() {
    inner class MainViewHolder(val itemBinding: RecyclerviewItemBinding)
        ...
        fun bindItem(task: Task){
            ...
            itemBinding.itemDetails.text = task.details
        }
    }
